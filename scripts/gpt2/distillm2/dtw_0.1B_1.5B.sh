...
VELOCITY_FIELD_CKPT="${BASE_PATH}/results/gpt2/train/velocity_field/distillm2/velocity_field.pth"
PROJECTOR_CKPT="${BASE_PATH}/results/gpt2/train/velocity_field/distillm2/projector.pth"
# data
...
BASE_ALPHA_2=0.1
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/dtw/distillm2/0.1B_1.5B"
# seed
SEED=10
...
# type (DTW is enabled under contra-type path in finetune.py)
OPTS+=" --type distillm2-v2-contra"
# gen
OPTS+=" --do-sample"
OPTS+=" --top-k 0"
OPTS+=" --top-p 1.0"
OPTS+=" --temperature 1.0"
# contra-kd config (projector needed for DTW alignment)
