...
VELOCITY_FIELD_CKPT="${BASE_PATH}/results/gpt2/train/velocity_field/velocity_field.pth"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/contra/fdd/base"
# seed
SEED=10
